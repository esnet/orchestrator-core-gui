...
I18n.translations.en = {
    ...
    forms: {
        ...
        fields: {
            ...
            latency_info:
                "Configured round-trip latency of this circuit, to be used in ISIS ECMP calculation. Leave value as 0 to automatically calculate latency",
            existing_subscription_info: "Existing Subscriptions",
            ignore_duplicate_detection: "Ignore Duplicate ECMP Group",
            ignore_duplicate_detection_info:
                "If an ECMP group exists between the two chosen endpoints, click this checkbox to create another. Should only be used in cases when another circuit with a different latency/preference combination is needed",
            ...
            generate_shipping_details_info:
                "Confirm outbound and return shippers are generated, optics and any patch fibers are in the shipping box, and we have Fedex tracking numbers.",
            ...
            request_remote_hands_work_info:
                "Confirm that field service request work is complete and time is logged in the Smart Hands google sheet tracker.",
            ...
            prefix_list_subscription_id:
                "Select an existing prefix list subscription to be applied to this service edge",
            prefix_list_subscription_ids: "Select multiple prefix list subscriptions for this service edge",
            prefix_list_terminate_warning:
